...
import { BlockQuote, Cite, Quote, Slide, Notes, Layout, Fill, Image } from "spectacle";
  ...
  render() {
    return (
      <Slide bgImage={images.wheelchair} bgDarken={0.7}>
        <Notes>
          <p>
            Imagine for a moment that subtitles, zooming, large buttons, color contrast and keyboard shortcuts didn't
            exist. Could you have interacted with that technology?
          </p>
          <p>
          ...
          >
            <BlockQuote style={meStyles.BlockQuote}>
              <Quote style={[meStyles.Quote, styles.standardText]}>
                I would say like 90% of your day is dictated by technology, and if you, as a person, are not included in
                that technology, what's the point if the app is fast?
              </Quote>
