    ...
    return (
      <Slide bgImage={images.wheelchair} bgDarken={0.7}>
        <Notes>
          ...
          How many of you, or your loved ones, interacted with your phone, watched tv, or otherwise interacted with
          technology during those experiences?
        </Notes>
        ...
        <Text textColor="primary" style={[styles.standardText, styles.littleSpacePlease]}>
          "When a person is denied access due to a technology barrier, the impairment to their ability did not occur
